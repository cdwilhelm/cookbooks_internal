...
when "ubuntu","debian"
  ruby_block "wsconfig" do
    block do
      system "/opt/jrun4/runtime/bin/wsconfig -server cfusion -ws Apache -dir /etc/apache2 -bin /usr/sbin/apache2 -script /usr/sbin/apache2ctl -coldfusion -v"
...
when "centos"
  ruby_block "wsconfig" do
    block do
      system "/opt/jrun4/runtime/bin/wsconfig -server cfusion -ws Apache -dir /etc/httpd/conf -bin /usr/sbin/httpd -script /usr/sbin/apachectl -coldfusion -v"
    end
  end
end
